        ...
        <div className='landing__main'>
          <div className='landing__main--wrapper'>
            ...
            <div className='video__content'>
              <h1>
                Masz dość tracenia czasu na przypadkowe powtarzanie słownictwa, które już doskonale
                znasz z przygotowanych planów?
              </h1>
              <h2>
                Z Praktycznym Angielskim możesz zapisywać w wyszukiwarce słowa, których znaczenia
                nie wiesz i uczyć ich się później.
              </h2>
        ...
        <div className='landing__works'>
          ...
          <div className='landing__works--single display-desktop'>
            ...
            <div className='landing__works--text-container'>
              ...
              <p>
                ...
                <span className='A-letter'>A</span> i zaloguj się do swojego konta, aby móc
                zapisywać słowa/zwroty.
              </p>
            </div>
          </div>
          ...
          <div className='landing__works--single'>
            <div className='landing__works--text-container'>
              ...
              <p>
                Odwiedź dowolną stronę w języku angielskim, zaznacz interesującą Cię frazę, kliknij
                prawym klawiszem myszy na zaznaczony tekst i wybierz opcję 'Zapisz do Praktycznego
                Angielskiego'.
              </p>
            </div>
            <img src={works3} />
          ...
          <div className='landing__works--single display-desktop'>
            ...
            <div className='landing__works--text-container'>
              ...
              <p>
                W dowolnym momencie wróć na naszą stronę i po zalogowaniu się możesz zacząć uczyć
                się zapisanych słów wybierając z menu na stronie opcję 'Rozpocznij naukę'.
              </p>
            </div>
          </div>
